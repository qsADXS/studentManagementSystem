...
public class StudentController {
    ...
    public Object grade(@PathVariable Integer id, HttpServletRequest request) {
        Claims claims = JwtUtils.getClaims(request);
        /*
         *这里的claims是一个map，里面存放了token中的信息
         *int level = (int)claims.get("level");
    ...
    public Object delCourse(@PathVariable Integer id, HttpServletRequest request) {
        Claims claims = JwtUtils.getClaims(request);
        /*
         *这里的claims是一个map，里面存放了token中的信息
         *int level = (int)claims.get("level");
    ...
    @GetMapping("/grade/{id}")
    public Object getGrade(@PathVariable Integer id, HttpServletRequest request) {
        Claims claims = JwtUtils.getClaims(request);
        /*
         *这里的claims是一个map，里面存放了token中的信息
         *int level = (int)claims.get("level");
